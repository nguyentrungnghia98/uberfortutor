...
WebUI.setText(findTestObject('Object Repository/Page_Gia S/input_Tr thnh gia s_search'), 'lý bá b')

WebUI.sendKeys(findTestObject('Object Repository/Page_Gia S/input_Tr thnh gia s_search'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Page_Gia S/div_L B Bgio vin50000hPh YnTon hcThng tin chi tit'))
